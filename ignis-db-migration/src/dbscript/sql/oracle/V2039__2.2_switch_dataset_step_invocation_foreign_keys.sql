ALTER TABLE DATASET
  ADD PIPELINE_STEP_INVOCATION_ID NUMBER(19,0);
...
ALTER TABLE PIPELINE_STEP_INVC_DATASET
  MODIFY (DATASET_ID NULL);

ALTER TABLE PIPELINE_STEP_INVC_DATASET
  ADD INPUT_PIPELINE_STEP_ID NUMBER(19, 0);
...
ALTER TABLE PIPELINE_INVOCATION
  ADD SERVICE_REQUEST_ID NUMBER(19, 0) DEFAULT NULL;

ALTER TABLE PIPELINE_INVOCATION
  ADD CONSTRAINT PI_SERVICE_REQUEST_FK
