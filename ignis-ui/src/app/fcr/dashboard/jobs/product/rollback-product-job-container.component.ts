...
@Component({
  templateUrl: "./rollback-product-job-container.component.html",
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RollbackProductJobContainerComponent implements OnInit {
  public jobExecution$: Observable<JobExecution>;

  constructor(
    public dialogRef: MatDialogRef<RollbackProductJobContainerComponent>,
